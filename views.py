...
def cash_in_hand(request):
   return render(request,'company/cash_in_hand.html')
def adjust_cash(request):
  return render(request,'company/adjust_cash.html')
@login_required
def view_cash_in_hand(request):
    
    cash = Cash_transaction.objects.all()

    return render(request, 'company/cash_in_hand.html', {'cih': cash})  
